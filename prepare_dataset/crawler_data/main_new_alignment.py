...
from prepare_dataset.crawler_data.config import parameter
from utls.faceevoLVe.align_trans import get_reference_facial_points, warp_and_crop_face
from utls.faceevoLVe.detector import detect_faces

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="face alignment")
    parser.add_argument("-source_root", "--source_root",
                        help="specify your source dir",
                        default=parameter.INPUT_PATH,
                        type=str)
    parser.add_argument("-dest_root", "--dest_root",
                        help="specify your destination dir",
                        default=parameter.OUTPUT_PATH,
                        type=str)
